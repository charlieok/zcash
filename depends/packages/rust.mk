...
$(package)_file_name_mingw64=rust-$($(package)_version)-x86_64-pc-windows-gnu.tar.gz
$(package)_sha256_hash_mingw64=55c07426f791c51c8a2b6934b35784175c4abb4e03f123f3e847109c4dc1ad8b
...
define $(package)_extract_cmds
  ...
  mkdir $(host_os) && \
  tar --strip-components=1 -xf $($(package)_source) -C $(host_os) && \
  mkdir buildos && \
...
define $(package)_stage_cmds
  ...
  cp -r ../$(host_os)/rust-std-x86_64-pc-windows-gnu/lib/rustlib/x86_64-pc-windows-gnu $($(package)_staging_dir)$(host_prefix)/native/lib/rustlib
endef
else
